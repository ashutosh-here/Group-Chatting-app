...
public class UserOne extends JFrame implements ActionListener, Runnable{
    ...
    UserOne(){         
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("groupchattingapplication/icons/1.png"));
       ...
       ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("groupchattingapplication/icons/phone.png"));
       ...
       ImageIcon i14 = new ImageIcon(ClassLoader.getSystemResource("groupchattingapplication/icons/3icon.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            writer.write(str);
            writer.write("\r\n");// \r to add the msg at the starting of the line
            writer.flush();
        }catch(Exception e){}
        t1.setText("");
